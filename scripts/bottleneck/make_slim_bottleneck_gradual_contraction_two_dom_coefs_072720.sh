...
# Make script
cat > slim_bottleneck_gradual_contraction_two_dom_coefs_${Na}Na_${Nb}Nb_${nF}nF_072720.slim << EOM
...
// bottleneck to K=1000 for 100 gens
$((${Na}*10+1)) early(){
