...
# Make script
cat > slim_bottleneck_${Na}Na_${Nb}Nb_${nF}nF_h${h}_only_str_del_muts_050420.slim << EOM
...
initialize() {
	...
	initializeMutationType("m1", 0, "s", "x=rgamma(1,-0.01314833,0.186); if(x<-0.01){;return(x);}else{;return(0);}");
